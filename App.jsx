    ...
    <div style={{ background: `${CREAM} repeating-linear-gradient(135deg, rgba(21,56,38,.025) 0 40px, rgba(21,56,38,0) 40px 80px)`, fontFamily: "'Segoe UI', Arial, sans-serif", minHeight: '100vh', animation: 'pageFade .7s cubic-bezier(.25,.46,.45,.94)' }}>
      ...
      <section className="relative overflow-hidden">
        {HERO_IMAGES.map((img, i) => (
          <div key={img} className="absolute inset-0" style={{ backgroundImage: `url('${img}')`, backgroundSize: 'cover', backgroundPosition: img === TERRACE_IMG ? 'center 5%' : 'center 12%', opacity: i === heroIdx ? 1 : 0, transition: 'opacity 1.8s ease-in-out', zIndex: 0 }} />
        ))}
        ...
        <div className="max-w-7xl mx-auto px-5 lg:px-10 pt-3 pb-16 lg:pt-4 lg:pb-24 grid lg:grid-cols-2 gap-10 items-center relative z-10">
          <div>
